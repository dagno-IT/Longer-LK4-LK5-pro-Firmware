...
#define STRING_CONFIG_H_AUTHOR "W.D. LK5 Pro by Dagno" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LK5 Pro BLTOUCH 1.0"
...
#if defined(LK5_Pro) || defined(LK5_Pro_BLTOUCH) // LK5_Pro
 ...
 */
#if defined(LK4_Pro_BLTOUCH) || defined(LK5_Pro_BLTOUCH)
  #define BLTOUCH
#else
//#define BLTOUCH
#endif
 ...
 */
#if defined(LK4_Pro_BLTOUCH) || defined(LK5_Pro_BLTOUCH) // TODO
...
#if defined(LK1_Pro) || defined(LK5_Pro)  || defined(LK5_Pro_BLTOUCH)
...
#if ENABLED(LK1_Pro_AutoBed) || ENABLED(LK4_Pro_BLTOUCH)  || ENABLED(LK5_Pro_BLTOUCH)
 ...
 */
#define LCD_LANGUAGE it  //french without accend for DGUS DWIN screen compatibilities
